...
import { fetchSurveyQuestions, saveFeedbacks, fetchResponses } from '../actions/AppActions';
            ...
            <View style={{ flex: 1, marginBottom: 20, marginTop: 0, width: '90%', justifyContent: 'center', alignSelf: 'center' }}>
              <View style={{ flex: 1, flexDirection: 'row', justifyContent: 'space-between', marginTop: 53 }}>
                  <TouchableOpacity activeOpacity={.5}>
                      <LinearGradient colors={['#C4C4C4', '#466A43']} style={{ height: 44, width: 147, borderRadius: 4 }} start={{ x: 0, y: 1 }}
                          end={{ x: 4, y: 1 }}
                          locations={[0, 0.3]}><Text style={{
                              fontSize: 18,
                              textAlign: 'center',
